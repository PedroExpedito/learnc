// Não foi feito por mim foi retirado do repositorio
// https://github.com/OsProgramadores/op-desafios/blob/master/desafio-05/kortkamp/c/desafio05.c
//
// Erro ARRAY muito grande
...
void *initialize_vars(void){
  puts("inicializando vars");
	...
	get_area_index("00");
  puts("terminou de inicializar vars");
}
...
int main(int argc, char *argv[]){
  ...
  pthread_create(&t1, NULL, process_entries, fp);
